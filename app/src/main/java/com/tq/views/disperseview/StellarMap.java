package com.tq.views.disperseview;
...
/*        addView(mHidenGroup,
                new LayoutParams(
                        getResources().getDimensionPixelSize(R.dimen.randomWidth),
                        getResources().getDimensionPixelSize(R.dimen.randomHeight)));*/
        addView(mHidenGroup, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
...
/*        addView(mShownGroup,
                new LayoutParams(
                        getResources().getDimensionPixelSize(R.dimen.randomWidth),
                        getResources().getDimensionPixelSize(R.dimen.randomHeight)));*/
        addView(mShownGroup, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
